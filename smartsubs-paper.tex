...
There are many other existing ways that videos can be presented to language
...
and filled out a questionnaire. They then repeated the task on another clip, with the other tool.
