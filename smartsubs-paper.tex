...
\emph{GliFlix} is a variant on the conventional, native-language subtitle, which inserts translations to the foreign language for the most common words that
appear in the dialog. They attain larger rates of vocabulary acquisition compared to regular
subtitles (though not dual subtitles) in user studies. However, compared to dual subtitles, GliFlix has the disadvantage that because it shows only the most common words in a dialog, then learners will not learn all the vocabulary in the video. Additionally, because GliFlix presents the foreign vocabulary in the order of the viewer’s native language, this approach is likely less beneficial than dual subtitles for
