...
We found that learners learned over twice as many new vocabulary
...
The Chinese and English subtitles were extracted from a DVD. %and OCR-ed to produce WebVTT-format subtitles.
...
Although our preliminary user study shows promising results
for vocabulary learning, further studies are needed to assess
...
this study shows only short-term vocabulary retention results.
Our participants were limited to intermediate-level learners,
so further studies are needed to determine whether it also benefits novice learners,
who may require additional scaffolding.
